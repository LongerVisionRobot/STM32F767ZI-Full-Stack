...
1. [Chapter 1. Getting Started with STM32](Part1_Introduction/01_Getting_Started_with_STM32/README.md)
    ...
    * [1.6 Package Update & Upgrade](Part1_Introduction/01_Getting_Started_with_STM32/06_package_updateupgrade.md)
2. [Chapter 2. GNU MCU Eclipse](Part1_Introduction/02_Getting_Familiar_with_Raspbian/README.md)
    * [2.1 Package Management](Part1_Introduction/02_Getting_Familiar_with_Raspbian/01_package_management.md)
    * [2.2 Matlab Like Bash](Part1_Introduction/02_Getting_Familiar_with_Raspbian/02_matlab_like_bash.md)
    * [2.3 Install Packages from Repository](Part1_Introduction/02_Getting_Familiar_with_Raspbian/03_install_packages_from_repository.md)
    * [2.4 Install Packages from Source](Part1_Introduction/02_Getting_Familiar_with_Raspbian/04_install_package_from_source.md)
